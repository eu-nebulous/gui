...
import {IResource, INodeCandidate, IRegions, ITypes} from "@/interfaces/resources.interface.ts"
...
interface ResourcesState {
    ...
    availableRegions: IRegions
    availableInstanceTypes: ITypes
}
...
export const useResourceStore = defineStore("resource", {
    ...
    actions: {
        async createResource(payload: IResourcePayload): Promise<IResource> {
            ...
            createdResource.platform = {
                'uuid': createdResource._platform[0].uuid,
                'title': createdResource._platform[0].title
            }
