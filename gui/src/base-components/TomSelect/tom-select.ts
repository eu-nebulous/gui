import { TomSelectProps, TomSelectElement, TomSelectEmit } from "./TomSelect.vue"
...
const init = (
  ...
  clonedEl.TomSelect.on("change", function (selectedItems: string[] | string) {
    emit("change", Array.isArray(selectedItems) ? [...selectedItems] : selectedItems)
  })

  return clonedEl.TomSelect
}
