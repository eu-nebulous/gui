...
import { FormattedMenu, nestedMenu } from "../SideMenu"
      ...
      <ul class="py-2">
        ...
        <template v-for="(menu, menuKey) in formattedMenu" :key="menuKey">
          ...
          <li v-else>
            ...
            >
              <div v-if="menu.icon" class="menu__icon">
            ...
            <Transition @enter="enter" @leave="leave">
              <ul v-if="menu.subMenu && menu.activeDropdown" :class="{ 'menu__sub-open': menu.activeDropdown }">
                <li v-for="(subMenu, subMenuKey) in menu.subMenu" :key="subMenuKey">
                  ...
                  >
                    <div v-if="subMenu.icon" class="menu__icon">
                  ...
                  <Transition @enter="enter" @leave="leave">
                    ...
                    >
                      <li v-for="(lastSubMenu, lastSubMenuKey) in subMenu.subMenu" :key="lastSubMenuKey">
                        ...
                        >
                          <div v-if="lastSubMenu.icon" class="menu__icon">
