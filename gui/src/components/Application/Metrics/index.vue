...
/* SLO */
const sloViolations = reactive<ISLExpression>(_.cloneDeep(props.payload.sloViolations))
  ...
  <div class="flex flex-col flex-grow space-y-8">
    ...
    <div class="flex gap-3 mb-5">
      <div>
        ...
        <FormInput
            v-model="sloViolations.violationThreshold"
            placeholder="1"/>
      </div>
      <div>
        <FormLabel>Evaluation Threshold (seconds)</FormLabel>
        <FormInput
            v-model="sloViolations.evaluationPeriod"
            placeholder="3600"/>
      </div>
    </div>
